...
@section('title', 'افزودن جاذبه گردشگری')
@section('content')
...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
	...
	@if( $message == "1" )
	<p> مکان گردشگری با موفقیت ثبت شده است</p>
	@endif
	<form action="{{ route('StoreAttraction') }}" method="post" enctype="multipart/form-data">
		@csrf
		<div>
		<p> آپلود تصویر :</p>
		<input type="file" name="photo" id="photo">
		<p style="font-size:20px;"> نام: </p>
		<input type="text" name="name" placeholder="نام مکان را وارد کنید" style="font-size:20px;">
		<br>
		<br>
		</div>
		<div >
