...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
	<div>
		...
		@endif
		<form action="{{route('UpdateAttraction',[$attraction])}}" method="post" enctype="multipart/form-data">
			@csrf
			<p> آپلود تصویری از مکان گردشگری:</p>
			<input type="file" name="photo" id="photo">

			<p style="font-size:20px;"> نام مکان گردشگری: </p>
			<input type="text" name="name" value="{{$attraction->name}}" style="font-size:20px;">

			<p style="font-size:20px;"> توضیحات مکان گردشگری : </p>
            <textarea  name="description" rows="10" style="font-size:18px;" class="w-75">{{$attraction->description}} </textarea>
			<br>
			<br>

			<div >
			<p style="font-size:20px;"> نام شهر  : </p>
			<input list="towns" name="town" id="town">
			<datalist id="towns">
