	...
	<div class="container-fluid">
		<ul class="navbar-nav">
			<li class="nav-item">
				...
				<a href="" class="navbar-brand hover:text-gray-700""><svg xmlns=" http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-image-alt" viewBox="0 0 16 16">
